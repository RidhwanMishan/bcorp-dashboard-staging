...
class FactsheetCoswayTWController extends Controller {
    ...
    public function __invoke() {
        ...
        if (session('email')) {
            ...
            $GLOBALS['fact'] = "Operating Locations"; //Change
            ...
            $pool_actvt[] = async(function(){
                ...
                AND entity_name = '".$GLOBALS['entity_name']."'
                ORDER by value_num desc, fact_value desc
            ");                
                return $value_actvt;
            ...
            $GLOBALS['category'] = "Our Activities"; //Change
            $GLOBALS['fact'] = "Breakdown of Business Revenue"; //Change
            ...
            $pool_keyfact[] = async(function(){
                ...
                FROM (
                    select fact, listagg(fact_value, '<br>') within group (order by sort_num) as details ,fact_value_2
                    from reporting.factsheet
            ...
            if($r_berjaya) {
                return view('factsheet.cosway_tw', [
