...
class ServicesController extends Controller {
    ...
    public function __invoke() {
        ...
        $GLOBALS['entity_name'] = "Services";
        $GLOBALS['vertical'] = "Services";
        ...
        if (session('email')) {
            ...
            $pool_revenue[] = async(function(){
                ...
                vertical,ytd_revenue,ytd_target,ytd_variance
            FROM
                reporting.pnl_vertical_services_revenue
            WHERE vertical = '".$GLOBALS['vertical']."'
            ;");                
            ...
            $pool_revenue_overview_graph[] = async(function(){
                ...
                order by vertical, fiscal_month
                ");                
            ...
            $pool_revenue_breakdown[] = async(function(){
                $value_revenue_breakdown = DB::connection('redshift')->select("SELECT
                industry, revenue
            FROM
                reporting.verticalpie_revenue
            WHERE vertical = '".$GLOBALS['vertical']."'
            ");                
            ...
            foreach($revenue_breakdown as $breakdown){
                array_push($revenue_breakdown_labels, $breakdown->industry);
            ...
            $pool_revenue_detailed_monthly[] = async(function(){
                $value_revenue_detailed_monthly = DB::connection('redshift')->select("SELECT
                fiscal_month,month_year,actual_month,target_amount
            FROM
                reporting.verticalmonthly_revenue
            WHERE vertical = '".$GLOBALS['vertical']."'
            ORDER BY fiscal_month, month_year
            ;");                
            ...
            $pool_revenue_detailed_quarterly[] = async(function(){
                $value_revenue_detailed_quarterly = DB::connection('redshift')->select("SELECT
                fiscal_quarter,actual_amount,target_amount
            FROM
                reporting.verticalquarterly_revenue
            WHERE vertical = '".$GLOBALS['vertical']."'
            ...
            $pool_revenue_detailed_monthly_variance[] = async(function(){
                $value_revenue_detailed_monthly_variance = DB::connection('redshift')->select("SELECT
                fiscal_month,month_year, monthly_variance
            FROM
                reporting.verticalmonthlyvar_revenue
            WHERE vertical = '".$GLOBALS['vertical']."'
            ORDER BY fiscal_month,month_year
                ");                
            ...
            $pool_revenue_detailed_quarterly_variance[] = async(function(){
                ...
                fiscal_quarter, quarterly_variance
            FROM
                reporting.verticalquarterlyvar_revenue
            WHERE vertical = '".$GLOBALS['vertical']."'
            ORDER BY fiscal_quarter
            ");                
            ...
            $pool_cos[] = async(function(){
                ...
                vertical,ytd_revenue,ytd_target,ytd_variance
            FROM
                reporting.pnl_vertical_costofsales
            WHERE vertical = '".$GLOBALS['vertical']."'
            ;");                
                return $value_cos;
                DB::close($value_cos);
            ...
            $pool_cos_breakdown[] = async(function(){
                $value_cos_breakdown = DB::connection('redshift')->select("SELECT
                industry, costofsales
            FROM
                reporting.verticalpie_costofsale
            WHERE vertical='".$GLOBALS['vertical']."'
            ");                
            ...
            foreach($cos_breakdown as $breakdown){
                $cos_breakdown_total += $breakdown->costofsales; 
            }

            foreach($cos_breakdown as $breakdown){
                array_push($cos_breakdown_labels, $breakdown->industry);

                $percentage_breakdown = ($breakdown->costofsales / $cos_breakdown_total) * 100; 
                $percentage_breakdown = round($percentage_breakdown, 2);
            ...
            // End COS Breakdown
             ...
             $pool_cos_detailed_monthly[] = async(function(){
                 $value_cos_detailed_monthly = DB::connection('redshift')->select("SELECT
                 fiscal_month,month_year,actual_month,target_amount
             FROM
                 reporting.verticalmonthly_costofsales
             WHERE vertical = '".$GLOBALS['vertical']."'
             ORDER BY fiscal_month, month_year
                 ");                
            ...
            $pool_cos_detailed_quarterly[] = async(function(){
                $value_cos_detailed_quarterly = DB::connection('redshift')->select("SELECT
                fiscal_quarter,actual_amount,target_amount
            FROM
                reporting.verticalquarterly_costofsales
            WHERE vertical = '".$GLOBALS['vertical']."'
            ORDER BY fiscal_quarter
                ");                
            ...
            // End COS - Detailed Data - quarterly Actual / Target
             ...
             $pool_cos_detailed_monthly_variance[] = async(function(){
                 $value_cos_detailed_monthly_variance = DB::connection('redshift')->select("SELECT
                 fiscal_month,month_year, monthly_variance
             FROM
                 reporting.verticalmonthlyvar_costofsale
             WHERE vertical = '".$GLOBALS['vertical']."'
             ORDER BY fiscal_month,month_year
                 ");                
            ...
            $pool_cos_detailed_quarterly_variance[] = async(function(){
                ...
                fiscal_quarter, quarterly_variance
            FROM
                reporting.verticalquarterlyvar_costofsales
            WHERE vertical = '".$GLOBALS['vertical']."'
            ORDER BY fiscal_quarter
            ");                
            ...
            $pool_gpl[] = async(function(){
                ...
                vertical,ytd_revenue,ytd_target,ytd_variance
            FROM
                reporting.pnl_vertical_grossprofit
            WHERE vertical = '".$GLOBALS['vertical']."'
            ;");                
                return $value_gpl;
                DB::close($value_gpl);
            ...
            $pool_gpl_breakdown[] = async(function(){
                $value_gpl_breakdown = DB::connection('redshift')->select("SELECT
                industry, grossprofit
            FROM
                reporting.verticalpie_grossprofit
            WHERE vertical='".$GLOBALS['vertical']."'
            ");                
            ...
            foreach($gpl_breakdown as $breakdown){
                $gpl_breakdown_total += $breakdown->grossprofit; 
            }

            foreach($gpl_breakdown as $breakdown){
                array_push($gpl_breakdown_labels, $breakdown->industry);

                $percentage_breakdown = ($breakdown->grossprofit / $gpl_breakdown_total) * 100; 
                $percentage_breakdown = round($percentage_breakdown, 2);
            ...
            $pool_gpl_detailed_monthly[] = async(function(){
                $value_gpl_detailed_monthly = DB::connection('redshift')->select("SELECT
                fiscal_month,month_year,actual_month,target_amount
            FROM
                reporting.verticalmonthly_grossprofit
            WHERE vertical = '".$GLOBALS['vertical']."'
            ORDER BY fiscal_month, month_year
                ");                
           ...
           $pool_gpl_detailed_quarterly[] = async(function(){
               $value_gpl_detailed_quarterly = DB::connection('redshift')->select("SELECT
               fiscal_quarter,actual_amount,target_amount
           FROM
               reporting.verticalquarterly_grossprofit
           WHERE vertical = '".$GLOBALS['vertical']."'
           ORDER BY fiscal_quarter
               ");                
           ...
           // End GROSS PROFIT / LOSS - Detailed Data - quarterly Actual / Target
            ...
            $pool_gpl_detailed_monthly_variance[] = async(function(){
                $value_gpl_detailed_monthly_variance = DB::connection('redshift')->select("SELECT
                fiscal_month,month_year, monthly_variance
            FROM
                reporting.verticalmonthlyvar_grossprofit
            WHERE vertical = '".$GLOBALS['vertical']."'
            ORDER BY fiscal_month,month_year
                ");                
           ...
           $pool_gpl_detailed_quarterly_variance[] = async(function(){
               ...
               fiscal_quarter, quarterly_variance
           FROM
               reporting.verticalquarterlyvar_grossprofit
           WHERE vertical = '".$GLOBALS['vertical']."'
           ORDER BY fiscal_quarter
           ");                
           ...
           // End GROSS PROFIT / LOSS - Detailed Data -  quarterly Variance
            ...
            $pool_opex[] = async(function(){
                ...
                vertical,ytd_revenue,ytd_target,ytd_variance
            FROM
                reporting.pnl_vertical_operatingexpense
            WHERE vertical = '".$GLOBALS['vertical']."'
            ;");                
                return $value_opex;
                DB::close($value_opex);
            ...
            $pool_opex_breakdown[] = async(function(){
                $value_opex_breakdown = DB::connection('redshift')->select("SELECT
                industry, operatingexpense
            FROM
                reporting.verticalpie_operatingexpense
            WHERE vertical='".$GLOBALS['vertical']."'
            ");                
            ...
            foreach($opex_breakdown as $breakdown){
                $opex_breakdown_total += $breakdown->operatingexpense; 
            }

            foreach($opex_breakdown as $breakdown){
                array_push($opex_breakdown_labels, $breakdown->industry);

                $percentage_breakdown = ($breakdown->operatingexpense / $opex_breakdown_total) * 100; 
                $percentage_breakdown = round($percentage_breakdown, 2);
            ...
            $pool_opex_detailed_monthly[] = async(function(){
                $value_opex_detailed_monthly = DB::connection('redshift')->select("SELECT
                fiscal_month,month_year,actual_month,target_amount
            FROM
                reporting.verticalmonthly_operatingexpense
            WHERE vertical = '".$GLOBALS['vertical']."'
            ORDER BY fiscal_month, month_year
                ");                
           ...
           $pool_opex_detailed_quarterly[] = async(function(){
               $value_opex_detailed_quarterly = DB::connection('redshift')->select("SELECT
               fiscal_quarter,actual_amount,target_amount
           FROM
               reporting.verticalquarterly_operatingexpense
           WHERE vertical = '".$GLOBALS['vertical']."'
           ORDER BY fiscal_quarter
               ");                
           ...
           // End OPEX - Detailed Data - quarterly Actual / Target
            ...
            $pool_opex_detailed_monthly_variance[] = async(function(){
                $value_opex_detailed_monthly_variance = DB::connection('redshift')->select("SELECT
                fiscal_month,month_year, monthly_variance
            FROM
                reporting.verticalmonthlyvar_operatingexpense
            WHERE vertical = '".$GLOBALS['vertical']."'
            ORDER BY fiscal_month,month_year
                ");                
           ...
           $pool_opex_detailed_quarterly_variance[] = async(function(){
               ...
               fiscal_quarter, quarterly_variance
           FROM
               reporting.verticalquarterlyvar_operatingexpense
           WHERE vertical = '".$GLOBALS['vertical']."'
           ORDER BY fiscal_quarter
           ");                
           ...
           // End OPEX - Detailed Data -  quarterly Variance
            ...
            $pool_ebitda_breakdown[] = async(function(){
                $value_ebitda_breakdown = DB::connection('redshift')->select("SELECT
                industry, ebitda
            FROM
                reporting.verticalpie_ebitda
            WHERE vertical='".$GLOBALS['vertical']."'
            ");                
            ...
            foreach($ebitda_breakdown as $breakdown){
                $ebitda_breakdown_total += $breakdown->ebitda; 
            }

            foreach($ebitda_breakdown as $breakdown){
                array_push($ebitda_breakdown_labels, $breakdown->industry);

                $percentage_breakdown = ($breakdown->ebitda / $ebitda_breakdown_total) * 100; 
                $percentage_breakdown = round($percentage_breakdown, 2);
                array_push($ebitda_breakdown_data, $percentage_breakdown);
            }

            // End EBITDA Breakdown Breakdown
            ...
            $pool_pat_breakdown[] = async(function(){
                $value_pat_breakdown = DB::connection('redshift')->select("SELECT industry, sum(dashboard_amount) AS revenue
                FROM reporting.pnl_monthly
                WHERE vertical='".$GLOBALS['vertical']."'
                AND fiscal_year=".$GLOBALS['fiscalyear']."
            ...
            foreach($pat_breakdown as $breakdown){
                array_push($pat_breakdown_labels, $breakdown->industry);
            ...
            $pool_pat_detailed_monthly[] = async(function(){
                $value_pat_detailed_monthly = DB::connection('redshift')->select("SELECT
                fiscal_month,month_year,actual_month,target_amount
            FROM
                reporting.verticalmonthly_pat
            WHERE vertical = '".$GLOBALS['vertical']."'
            ORDER BY fiscal_month, month_year
                ");                
           ...
           $pool_pat_detailed_quarterly[] = async(function(){
               $value_pat_detailed_quarterly = DB::connection('redshift')->select("SELECT
               fiscal_quarter,actual_amount,target_amount
           FROM
               reporting.verticalquarterly_pat
           WHERE vertical = '".$GLOBALS['vertical']."'
           ORDER BY fiscal_quarter
               ");                
           ...
           // End PAT - Detailed Data - quarterly Actual / Target
            ...
            $pool_pat_detailed_monthly_variance[] = async(function(){
                $value_pat_detailed_monthly_variance = DB::connection('redshift')->select("SELECT
                fiscal_month,month_year, monthly_variance
            FROM
                reporting.verticalmonthlyvar_pat
            WHERE vertical = '".$GLOBALS['vertical']."'
            ORDER BY fiscal_month,month_year
                ");                
           ...
           $pool_pat_detailed_quarterly_variance[] = async(function(){
               ...
               fiscal_quarter, quarterly_variance
           FROM
               reporting.verticalquarterlyvar_pat
           WHERE vertical = '".$GLOBALS['vertical']."'
           ORDER BY fiscal_quarter
           ");                
        ...
        //dd($GLOBALS['detailed_breakdown_collection']);
            ...
            if ($enviro_holdings) {
                return redirect()->route('services.env_enviro_holdings');
            } else if ($enviro_parks) {
                return redirect()->route('services.env_enviroparks');
            } else if ($logi_secure) {
                return redirect()->route('services.logi_secure');
            } else if ($redtone) {
                return redirect()->route('services.digi_redtone');
            } else if ($nist) {
                return redirect()->route('services.digi_nist');
            } else if ($nis) {
                return redirect()->route('services.digi_nis');
            } else if ($bloyalty) {
                return redirect()->route('services.digi_bloyalty');
            } else if ($bloyaltyltd) {
                return redirect()->route('services.digi_bloyaltyltd');
            } else {
