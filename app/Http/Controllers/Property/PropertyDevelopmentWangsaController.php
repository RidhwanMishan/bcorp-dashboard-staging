...
class PropertyDevelopmentWangsaController extends Controller {
    ...
    public function __invoke() {
        ...
        $GLOBALS['entity_name'] = "Wangsa Tegap Sdn Bhd"; //Can change depending on what company
        ...
        //dd($GLOBALS['detailed_breakdown_collection']);
            ...
            if($r_berjaya) {
                return view('property.development_wangsa', [
