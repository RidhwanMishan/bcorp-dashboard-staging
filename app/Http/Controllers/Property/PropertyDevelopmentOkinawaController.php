...
class PropertyDevelopmentOkinawaController extends Controller {
    ...
    public function __invoke() {
        ...
        $GLOBALS['entity_name'] = "Berjaya Okinawa Development Co. Ltd"; //Can change depending on what company
        ...
        //dd($GLOBALS['detailed_breakdown_collection']);
            ...
            if($r_berjaya) {
                return view('property.development_okinawa', [
