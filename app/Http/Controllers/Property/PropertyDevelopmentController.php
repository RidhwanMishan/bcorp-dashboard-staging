...
class PropertyDevelopmentController extends Controller {
    ...
    public function __invoke() {
        ...
        $GLOBALS['entity_name'] = "Property Development";
        $GLOBALS['vertical'] = "Property";
        $GLOBALS['industry'] = "Property Development";
        ...
        //dd($GLOBALS['detailed_breakdown_collection']);
            ...
            if($r_berjaya) {
                return view('property.development', [
