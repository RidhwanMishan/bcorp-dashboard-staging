...
class BerjayaController extends Controller {
    ...
    public function __invoke() {
        ...
        if (session('email')) {
            ...
            $pool_revenue_overview_graph[] = async(function(){
                ...
                order by overall_segment, fiscal_month
                ");                
            ...
            $pool_revenue_breakdown[] = async(function(){
                $value_revenue_breakdown = DB::connection('redshift')->select("SELECT overall_segment,vertical,revenue
                FROM reporting.overallpiechart_revenue
                ");                
            ...
            foreach($revenue_breakdown as $breakdown){
                array_push($revenue_breakdown_labels, $breakdown->vertical);
            ...
            $pool_revenue_detailed_monthly[] = async(function(){
                $value_revenue_detailed_monthly = DB::connection('redshift')->select("SELECT overall_segment,month_year,dashboard_amount,target_amount
                FROM reporting.overallgraph1_revenue
                ");                
            ...
            //dd($revenue_detailed_monthly_data_actual);
            ...
            $pool_revenue_detailed_quarterly[] = async(function(){
                $value_revenue_detailed_quarterly = DB::connection('redshift')->select("SELECT overall_segment,fiscal_quarter, dashboard_amount,target_amount
                FROM reporting.overallquartely_revenue
                ");                
            ...
            $pool_revenue_detailed_monthly_variance[] = async(function(){
                $value_revenue_detailed_monthly_variance = DB::connection('redshift')->select("SELECT overall_segment,fiscal_month,month_year,monthly_variance
                FROM reporting.overallmonthly_revenue
                ");                
            ...
            $pool_revenue_detailed_quarterly_variance[] = async(function(){
                $value_revenue_detailed_quarterly_variance = DB::connection('redshift')->select("SELECT overall_segment,fiscal_quarter,quarterly_variance
                FROM reporting.overallqrtvariance_revenue                
                ");                
            ...
            $pool_cos_breakdown[] = async(function(){
                $value_cos_breakdown = DB::connection('redshift')->select("SELECT overall_segment,vertical,revenue
                FROM reporting.overallpiechart_cos");                
            ...
            foreach($cos_breakdown as $breakdown){
                array_push($cos_breakdown_labels, $breakdown->vertical);
            ...
            // End COS Breakdown
             ...
             $pool_cos_detailed_monthly[] = async(function(){
                 $value_cos_detailed_monthly = DB::connection('redshift')->select("SELECT overall_segment,month_year,dashboard_amount,target_amount
                 FROM reporting.overallgraph1_cos
                 ");                
            ...
            $pool_cos_detailed_quarterly[] = async(function(){
                $value_cos_detailed_quarterly = DB::connection('redshift')->select("SELECT overall_segment,fiscal_quarter, dashboard_amount,target_amount
                FROM reporting.overallquartely_cos
                ");                
            ...
            // End COS - Detailed Data - quarterly Actual / Target
             ...
             $pool_cos_detailed_monthly_variance[] = async(function(){
                 $value_cos_detailed_monthly_variance = DB::connection('redshift')->select("SELECT overall_segment,fiscal_month,month_year, monthly_variance
                 FROM reporting.overallmonthly_cos
                 ");                
            ...
            $pool_cos_detailed_quarterly_variance[] = async(function(){
                $value_cos_detailed_quarterly_variance = DB::connection('redshift')->select("SELECT overall_segment,fiscal_quarter,quarterly_variance
                FROM reporting.overallqrtvariance_cos
                ");                
            ...
            $pool_gpl_breakdown[] = async(function(){
                $value_gpl_breakdown = DB::connection('redshift')->select("SELECT overall_segment,vertical,revenue
                FROM reporting.overallpiechart_gpl
                ");                
            ...
            foreach($gpl_breakdown as $breakdown){
                array_push($gpl_breakdown_labels, $breakdown->vertical);
            ...
            $pool_gpl_detailed_monthly[] = async(function(){
                $value_gpl_detailed_monthly = DB::connection('redshift')->select("SELECT overall_segment,month_year,dashboard_amount,target_amount
                FROM reporting.overallgraph1_gpl
                ");                
            ...
            foreach($gpl_detailed_monthly as $breakdown){
                ...
                array_push($gpl_detailed_monthly_data_actual, $breakdown->dashboard_amount);
           ...
           $pool_gpl_detailed_quarterly[] = async(function(){
               $value_gpl_detailed_quarterly = DB::connection('redshift')->select("SELECT overall_segment,fiscal_quarter, dashboard_amount,target_amount
               FROM reporting.overallquartely_gpl
               ");                
           ...
           // End GROSS PROFIT / LOSS - Detailed Data - quarterly Actual / Target
            ...
            $pool_gpl_detailed_monthly_variance[] = async(function(){
                $value_gpl_detailed_monthly_variance = DB::connection('redshift')->select("SELECT overall_segment,fiscal_month,month_year, monthly_variance
                FROM reporting.overallmonthly_gpl
                ");                
           ...
           $pool_gpl_detailed_quarterly_variance[] = async(function(){
               $value_gpl_detailed_quarterly_variance = DB::connection('redshift')->select("SELECT overall_segment,fiscal_quarter,quarterly_variance
               FROM reporting.overallqrtvariance_gpl
               ");                
           ...
           // End GROSS PROFIT / LOSS - Detailed Data -  quarterly Variance
            ...
            $pool_opex_breakdown[] = async(function(){
                $value_opex_breakdown = DB::connection('redshift')->select("SELECT overall_segment,vertical,revenue
                FROM reporting.overallpiechart_op
                ");                
            ...
            foreach($opex_breakdown as $breakdown){
                array_push($opex_breakdown_labels, $breakdown->vertical);
            ...
            $pool_opex_detailed_monthly[] = async(function(){
                $value_opex_detailed_monthly = DB::connection('redshift')->select("SELECT overall_segment,month_year,dashboard_amount,target_amount
                FROM reporting.overallgraph1_op
                ");                
            ...
            foreach($opex_detailed_monthly as $breakdown){
                ...
                array_push($opex_detailed_monthly_data_actual, $breakdown->dashboard_amount);
           ...
           $pool_opex_detailed_quarterly[] = async(function(){
               $value_opex_detailed_quarterly = DB::connection('redshift')->select("SELECT overall_segment,fiscal_quarter, dashboard_amount,target_amount
               FROM reporting.overallquartely_op
               ");                
           ...
           // End OPEX - Detailed Data - quarterly Actual / Target
            ...
            $pool_opex_detailed_monthly_variance[] = async(function(){
                $value_opex_detailed_monthly_variance = DB::connection('redshift')->select("SELECT overall_segment,fiscal_month,month_year, monthly_variance
                FROM reporting.overallmonthly_op
                ");                
           ...
           $pool_opex_detailed_quarterly_variance[] = async(function(){
               $value_opex_detailed_quarterly_variance = DB::connection('redshift')->select("SELECT overall_segment,fiscal_quarter,quarterly_variance
               FROM reporting.overallqrtvariance_op
               ");                
           ...
           // End OPEX - Detailed Data -  quarterly Variance
            ...
            $pool_ebitda_breakdown[] = async(function(){
                $value_ebitda_breakdown = DB::connection('redshift')->select("SELECT overall_segment,vertical,revenue
                FROM reporting.overallpiechart_ebitda
                ");                
            ...
            foreach($ebitda_breakdown as $breakdown){
                array_push($ebitda_breakdown_labels, $breakdown->vertical);
            ...
            $pool_pat_breakdown[] = async(function(){
                $value_pat_breakdown = DB::connection('redshift')->select("SELECT overall_segment,vertical,revenue
                FROM reporting.overallpiechart_pat
                ");                
            ...
            foreach($pat_breakdown as $breakdown){
                array_push($pat_breakdown_labels, $breakdown->vertical);
            ...
            $pool_pat_detailed_monthly[] = async(function(){
                $value_pat_detailed_monthly = DB::connection('redshift')->select("SELECT overall_segment,month_year,dashboard_amount,target_amount
                FROM reporting.overallgraph1_pat
                ");                
            ...
            foreach($pat_detailed_monthly as $breakdown){
                ...
                array_push($pat_detailed_monthly_data_actual, $breakdown->dashboard_amount);
           ...
           $pool_pat_detailed_quarterly[] = async(function(){
               $value_pat_detailed_quarterly = DB::connection('redshift')->select("SELECT overall_segment,fiscal_quarter, dashboard_amount,target_amount
               FROM reporting.overallquartely_pat
               ");                
           ...
           // End PAT - Detailed Data - quarterly Actual / Target
            ...
            $pool_pat_detailed_monthly_variance[] = async(function(){
                $value_pat_detailed_monthly_variance = DB::connection('redshift')->select("SELECT overall_segment,fiscal_month,month_year, monthly_variance
                FROM reporting.overallmonthly_pat
                ");                
           ...
           $pool_pat_detailed_quarterly_variance[] = async(function(){
               $value_pat_detailed_quarterly_variance = DB::connection('redshift')->select("SELECT overall_segment,fiscal_quarter,quarterly_variance
               FROM reporting.overallqrtvariance_pat
               ");                
           ...
           foreach($breakdown_array as $breakdown){
               ...
               $GLOBALS['breakdown_account_name'] = $breakdown->vertical;
               ...
               // Start MONTHLY ACTUAL / TARGET BREAKDOWN 
                ...
                $pool_breakdown_monthly_actual_target[] = async(function(){
                    $value_breakdown_monthly_actual_target = DB::connection('redshift')->select("SELECT 
                    overall_segment,
                    fiscal_month,
                    vertical,
                    month_year,
                    sum (dashboard_amount) as dashboard_amount,
                    sum (target_amount) as target_amount
                    FROM reporting.pnl_monthly
                    WHERE fiscal_year = '".$GLOBALS['fiscalyear']."'
                    AND account_name = '".$GLOBALS['parent_account_name']."'
                    AND vertical = '".$GLOBALS['breakdown_account_name']."'
                    GROUP BY overall_segment, fiscal_month, vertical, month_year
                    ORDER BY fiscal_month
                    ;");                
                ...
                foreach($breakdown_monthly_actual_target_result[0] as $breakdown_result){
                    ...
                    array_push($breakdown_detailed_monthly_actual,$breakdown_result->dashboard_amount);
                    array_push($breakdown_detailed_monthly_target,$breakdown_result->target_amount);
                }
                ...
                $pool_breakdown_cumulative_actual_target[] = async(function(){
                    $value_breakdown_cumulative_actual_target = DB::connection('redshift')->select("SELECT overall_segment, month_year, fiscal_month, vertical,
                    (SELECT sum(dashboard_amount) FROM reporting.pnl_monthly pnl 
                    WHERE pnl.fiscal_month::int<=rpt.fiscal_month::int
                    AND account_name = '".$GLOBALS['parent_account_name']."'
                    AND vertical = '".$GLOBALS['breakdown_account_name']."'
                    AND overall_segment=rpt.overall_segment) as dashboard_amount,
                    (SELECT sum(target_amount) FROM reporting.pnl_monthly pnl 
                    WHERE pnl.fiscal_month::int<=rpt.fiscal_month::int
                    AND account_name = '".$GLOBALS['parent_account_name']."'
                    AND vertical = '".$GLOBALS['breakdown_account_name']."'
                    AND overall_segment=rpt.overall_segment) as target_amount
             FROM (SELECT DISTINCT overall_segment, month_year, fiscal_month, vertical FROM reporting.pnl_monthly) AS rpt
             order by fiscal_month
                ;");                
                ...
                foreach($breakdown_cumulative_actual_target_result[0] as $breakdown_result){
                    ...
                    array_push($breakdown_detailed_cumulative_monthly_actual,$breakdown_result->dashboard_amount);
                    array_push($breakdown_detailed_cumulative_monthly_target,$breakdown_result->target_amount);
                }
                ...
                $pool_breakdown_quarterly_actual_target[] = async(function(){
                    ...
                    WHERE pm.fiscal_year = '".$GLOBALS['fiscalyear']."'
                    AND account_name = '".$GLOBALS['parent_account_name']."'
                    AND vertical = '".$GLOBALS['breakdown_account_name']."'
                    GROUP BY overall_segment, pm.fiscal_quarter, fiscal_quarter_str,vertical
                    ORDER BY fq
                    ;");                
                ...
                foreach($breakdown_quarterly_actual_target_result[0] as $breakdown_result){
                    ...
                    array_push($breakdown_detailed_quarterly_actual_target_actual,$breakdown_result->dashboard_amount);
                ...
                $pool_breakdown_monthly_variance[] = async(function(){
                    $value_breakdown_monthly_variance = DB::connection('redshift')->select("SELECT 
                    overall_segment, 
                    fiscal_month, 
                    month_year,
                    vertical,
                    sum(target_amount)-sum(dashboard_amount) as monthly_variance   
                    FROM reporting.pnl_monthly
                    WHERE fiscal_year= '".$GLOBALS['fiscalyear']."'
                    AND account_name = '".$GLOBALS['parent_account_name']."'
                    AND vertical = '".$GLOBALS['breakdown_account_name']."'
                    GROUP BY overall_segment, fiscal_month, month_year, vertical
                    ORDER BY fiscal_month
                    ;");                
                ...
                foreach($breakdown_monthly_variance_result[0] as $breakdown_result){
                    array_push($breakdown_monthly_variance_labels,$breakdown_result->month_year);
                ...
                $pool_breakdown_cumatively_variance[] = async(function(){
                    $value_breakdown_cumatively_variance = DB::connection('redshift')->select("SELECT overall_segment, month_year, fiscal_month, vertical,
                    (SELECT sum(target_amount)-sum(dashboard_amount) 
                    FROM reporting.pnl_monthly pnl 
                    WHERE pnl.fiscal_month::int<=rpt.fiscal_month::int
                    AND account_name = '".$GLOBALS['parent_account_name']."'
                    AND vertical = '".$GLOBALS['breakdown_account_name']."'
                    AND overall_segment=rpt.overall_segment) as cum_variance
             FROM (SELECT DISTINCT overall_segment, month_year, fiscal_month, vertical FROM reporting.pnl_monthly) AS rpt
             order by fiscal_month
             ;");                
                ...
                foreach($breakdown_cumatively_variance_result[0] as $breakdown_result){
                    ...
                    array_push($breakdown_cumatively_variance_actual,$breakdown_result->cum_variance);
                }
