...
class RetailFoodJollibeanController extends Controller {
    ...
    public function __invoke() {
        ...
        $GLOBALS['entity_name'] = "Jollibean Foods Pte Ltd"; //Can change depending on what company
        ...
        //dd($revenue_detailed_monthly_data_actual);
            ...
            if($r_berjaya) {
                return view('retail.food_jollibean', [
