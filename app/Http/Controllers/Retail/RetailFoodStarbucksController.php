...
class RetailFoodStarbucksController extends Controller {
    ...
    public function __invoke() {
        ...
        $GLOBALS['entity_name'] = "Berjaya Starbucks Coffee"; //Can change depending on what company
        ...
        //dd($GLOBALS['detailed_breakdown_collection']);
            ...
            if($r_berjaya) {
                return view('retail.food_starbucks', [
