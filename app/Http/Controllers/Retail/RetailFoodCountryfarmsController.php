...
class RetailFoodCountryfarmsController extends Controller {
    ...
    public function __invoke() {
        ...
        $GLOBALS['entity_name'] = "Country Farms Sdn Bhd"; //Can change depending on what company
        ...
        // dd($revenue);
            ...
            if($r_berjaya) {
                return view('retail.food_countryfarms', [
