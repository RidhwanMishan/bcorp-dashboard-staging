...
class RetailFoodKrispykremeController extends Controller {
    ...
    public function __invoke() {
        ...
        $GLOBALS['entity_name'] = "Berjaya Krispy Kreme Doughnuts Sdn Bhd"; //Can change depending on what company
        ...
        //dd($GLOBALS['detailed_breakdown_collection']);
            ...
            if($r_berjaya) {
                return view('retail.food_krispykreme', [
