...
class ServicesEnvEnviroParksController extends Controller {
    ...
    public function __invoke() {
        ...
        $GLOBALS['entity_name'] = "Berjaya EnviroParks Sdn Bhd"; //Can change depending on what company
        ...
        //dd($GLOBALS['detailed_breakdown_collection']);
            ...
            if($r_berjaya) {
                return view('services.env_enviroparks', [
                ...
                'enviro_holdings'=>$enviro_holdings, 
                'enviro_parks'=>$enviro_parks,
