...
class ServicesFinancialAssetController extends Controller {
    ...
    public function __invoke() {
        ...
        $GLOBALS['entity_name'] = "Inter-Pacific Asset Management Sdn Bhd"; //Can change depending on what company
        ...
        //dd($GLOBALS['detailed_breakdown_collection']);
            ...
            if($r_berjaya) {
                return view('services.financial_asset', [
