...
class ServicesDigiNisController extends Controller {
    ...
    public function __invoke() {
        ...
        $GLOBALS['entity_name'] = "Natural Intelligence Solutions Pte Ltd"; //Can change depending on what company
 ...
 //
        ...
        //dd($opex_overview_graph);
        
            if($r_berjaya) {
                return view('services.digi_nis', [
