...
class ServicesGamingController extends Controller {
    ...
    public function __invoke() {
        ...
        $GLOBALS['entity_name'] = "Digital Services";
        $GLOBALS['vertical'] = "Services";
        $GLOBALS['industry'] = "Digital Services";
        ...
        if (session('email')) {
            ...
            $pool_revenue_detailed_monthly_variance[] = async(function(){
                $value_revenue_detailed_monthly_variance = DB::connection('redshift')->select("SELECT industry, fiscal_month,monthly_variance
            ...
            foreach($revenue_detailed_monthly_variance as $breakdown){
                array_push($revenue_detailed_monthly_variance_data_labels, $breakdown->fiscal_month);
            ...
            // End COS - Detailed Data - quarterly Actual / Target
             ...
             $pool_cos_detailed_monthly_variance[] = async(function(){
                 $value_cos_detailed_monthly_variance = DB::connection('redshift')->select("SELECT industry, fiscal_month,monthly_variance
             ...
             foreach($cos_detailed_monthly_variance as $breakdown){
                 array_push($cos_detailed_monthly_variance_data_labels, $breakdown->fiscal_month);
           ...
           // End GROSS PROFIT / LOSS - Detailed Data - quarterly Actual / Target
            ...
            $pool_gpl_detailed_monthly_variance[] = async(function(){
                $value_gpl_detailed_monthly_variance = DB::connection('redshift')->select("SELECT industry, fiscal_month,monthly_variance
            ...
            foreach($gpl_detailed_monthly_variance as $breakdown){
                array_push($gpl_detailed_monthly_variance_data_labels, $breakdown->fiscal_month);
           ...
           // End OPEX - Detailed Data - quarterly Actual / Target
            ...
            $pool_opex_detailed_monthly_variance[] = async(function(){
                $value_opex_detailed_monthly_variance = DB::connection('redshift')->select("SELECT industry, fiscal_month,monthly_variance
            ...
            foreach($opex_detailed_monthly_variance as $breakdown){
                array_push($opex_detailed_monthly_variance_data_labels, $breakdown->fiscal_month);
           ...
           // End PAT - Detailed Data - quarterly Actual / Target
            ...
            $pool_pat_detailed_monthly_variance[] = async(function(){
                $value_pat_detailed_monthly_variance = DB::connection('redshift')->select("SELECT industry, fiscal_month,monthly_variance
            ...
            foreach($pat_detailed_monthly_variance as $breakdown){
                array_push($pat_detailed_monthly_variance_data_labels, $breakdown->fiscal_month);
