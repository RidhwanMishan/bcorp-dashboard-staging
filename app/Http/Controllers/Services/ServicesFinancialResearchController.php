...
class ServicesFinancialResearchController extends Controller {
    ...
    public function __invoke() {
        ...
        $GLOBALS['entity_name'] = "Inter-Pacific Research Sdn Bhd"; //Can change depending on what company
        ...
        //dd($GLOBALS['detailed_breakdown_collection']);
            ...
            if($r_berjaya) {
                return view('services.financial_research', [
