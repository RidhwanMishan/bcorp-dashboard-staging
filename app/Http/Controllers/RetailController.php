...
class RetailController extends Controller {
    ...
    public function __invoke() {
        ...
        $GLOBALS['entity_name'] = "Retail";
        $GLOBALS['vertical'] = "Retail";
        ...
        //dd($GLOBALS['detailed_breakdown_collection']);
            ...
            if ($cosway) {
                return redirect()->route('retail.nonfood_cosway');
            } else if ($coswaytw) {
                return redirect()->route('retail.nonfood_coswaytw');
            } else if ($coswayhk) {
                return redirect()->route('retail.nonfood_coswayhk');
            } else if ($country_farms) {
                return redirect()->route('retail.food_countryfarms');
            }
            else {
