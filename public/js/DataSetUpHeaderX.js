...
var revenueDetailedData = [];
  ...
  var revenueCumulativeActualTargetData = {
    ...
    labels: ["Juli","August","September","October","November","December","January","February","March","April","May","June"],
  ...
  var costOfSaleCurrentMonthBreakdownData = {
    ...
    labels: ["Cost of Good Sold", "Other COGS Expense"],
  ...
  var operatingExpenseCurrentMonthBreakdownData = {
    ...
    labels: ["Fixed OPEX","Variable OPEX"],
