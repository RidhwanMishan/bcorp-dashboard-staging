...
var detailedDataCollection ={"dataGroups" :[]};
  ...
  var revenueCurrentMonthBreakdownData = {
    ...
    labels: ["Stores","Online Stores","Members","Membership Base","Kimia Suchi"],
  ...
  // START REVENUE PREVIOUS MONTH BREAKDOWN PIE CHART
  var revenuePreviousMonthBreakdownData = {
    datasets: [{
      data: [40, 25, 5,15,15],
      backgroundColor: preChosenBackgroundColors
    }],
    labels: ["Stores","Online Stores","Members","Membership Base","Kimia Suchi"],
    elementId: ["Revenue_Previous_Month_Breakdown"],
    chartType: ['pie'],
    legend: true, 
    breakdown: true
  };

  pieChartBreakdownData.push(revenuePreviousMonthBreakdownData);
  
  // END REVENUE PREVIOUS MONTH BREAKDOWN PIE CHART
  ...
  var costOfSaleCurrentMonthBreakdownData = {
    ...
    labels: ["Cost of good sold","Sales commission","Other COGS expense"],
  ...
  // END COST OF SALE CURRENT MONTH BREAKDOWN PIE CHART
    ...
    // START COST OF SALE PREVIOUS MONTH BREAKDOWN PIE CHART
    var costOfSalePreviousMonthBreakdownData = {
      datasets: [{
        data: [20, 20, 60],
        backgroundColor: preChosenBackgroundColors
      }],
      labels: ["Cost of good sold","Sales commission","Other COGS expense"],
      elementId: ["Cost_Of_Sale_Previous_Month_Breakdown"],
      chartType: ['pie'],
      legend: true, 
      breakdown: true
    };
  
    pieChartBreakdownData.push(costOfSalePreviousMonthBreakdownData);
    
    // END COST OF SALE PREVIOUS MONTH BREAKDOWN PIE CHART
  ...
  // END GROSS PROFIT / LOSS CURRENT MONTH BREAKDOWN PIE CHART    
   ...
   // START GROSS PROFIT / LOSS PREVIOUS MONTH BREAKDOWN PIE CHART
   var grossProfitLossPreviousMonthBreakdownData = {
    datasets: [{
      data: [5, 10, 15, 60],
      backgroundColor: preChosenBackgroundColors
    }],
    labels: ["A","B","C","D"],
    elementId: ["Gross_Profit_Loss_Previous_Month_Breakdown"],
    chartType: ['pie'],
    legend: true, 
    breakdown: true
  };

  pieChartBreakdownData.push(grossProfitLossPreviousMonthBreakdownData);
  
  // END GROSS PROFIT / LOSS PREVIOUS MONTH BREAKDOWN PIE CHART   
  ...
  var operatingExpenseCurrentMonthBreakdownData = {
    ...
    labels: ["Fixed OPEX","Variance OPEX"],
  ...
  // START OPERATING EXPENSE PREVIOUS MONTH BREAKDOWN PIE CHART
  var operatingExpensePreviousMonthBreakdownData = {
    datasets: [{
      data: [50, 50],
      backgroundColor: preChosenBackgroundColors
    }],
    labels: ["Fixed OPEX","Variance OPEX"],
    elementId: ["Operating_Expense_Previous_Month_Breakdown"],
    chartType: ['pie'],
    legend: true, 
    breakdown: true
  };

  pieChartBreakdownData.push(operatingExpensePreviousMonthBreakdownData);

  // END OPERATING EXPENSE PREVIOUS MONTH BREAKDOWN PIE CHART 
  ...
  // START EBITDA PREVIOUS MONTH BREAKDOWN PIE CHART
  var ebitdaPreviousMonthBreakdownData = {
    datasets: [{
      data: [10,20,10,20,40],
      backgroundColor: preChosenBackgroundColors
    }],
    labels: ["A","B","C","D","E"],
    elementId: ["EBITDA_Previous_Month_Breakdown"],
    chartType: ['pie'],
    legend: true, 
    breakdown: true
  };

  pieChartBreakdownData.push(ebitdaPreviousMonthBreakdownData);

  // END EBITDA PREVIOUS MONTH BREAKDOWN PIE CHART 


  // START COGS CURRENT MONTH BREAKDOWN PIE CHART
  var cogsCurrentMonthBreakdownData = {
    datasets: [{
      data: [10,15,10,20,5,20,10,10],
      backgroundColor: preChosenBackgroundColors
    }],
  ...
  // START COGS PREVIOUS MONTH BREAKDOWN PIE CHART
  var cogsPreviousMonthBreakdownData = {
    datasets: [{
      data: [5,15,10,25,5,20,5,15],
      backgroundColor: preChosenBackgroundColors
    }],
    labels: ["A","B","C","D","E","F","G","H"],
    elementId: ["COGS_Previous_Month_Breakdown"],
    chartType: ['pie'],
    legend: true, 
    breakdown: true
  };

  pieChartBreakdownData.push(cogsPreviousMonthBreakdownData);
  
  // END PAT PREVIOUS MONTH BREAKDOWN PIE CHART 
