...
@section('title') Retail > Food > Jollibean @endsection
    ...
    <div class="slim-pageheader">
        ...
        <div class="level-up">
          ...
          <a href="/retail/food/countryfarms"><button class="btn btn-primary mg-r-10">Country Farms</button></a>
            <a href="/retail/food/jollibean"><button class="btn btn-success mg-r-10">Jollibean</button></a>
        ...
        <h6 class="slim-pagetitle">Retail - Food - Jollibean</h6>
    </div>
