...
@section('title') Retail > Non-Food > H.R. Owen @endsection
...
<div class="slim-mainpanel company">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/retail/non-food/hrowen"><button class="btn btn-success mg-r-10">H.R. Owen</button></a>
        </div>
        <h6 class="slim-pagetitle">Retail - Non-Food - H.R. Owen</h6>
    </div>
