...
@section('title') Retail > Food > Krispy Kreme @endsection
    ...
    <div class="slim-pageheader">
        ...
        <div class="level-up">
          ...
          <a href="/retail/food/countryfarms"><button class="btn btn-primary mg-r-10">Country Farms</button></a>
            ...
            <a href="/retail/food/krispykreme"><button class="btn btn-success mg-r-10">Krispy Kreme</button></a>
        ...
        <h6 class="slim-pagetitle">Retail - Food - Krispy Kreme</h6>
    </div>
