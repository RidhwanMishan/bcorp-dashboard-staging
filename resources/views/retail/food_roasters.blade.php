...
@section('title') Retail > Food > Roasters @endsection
...
<div class="slim-mainpanel company">
    ...
    <div class="slim-pageheader">
        <div>
        <div class="level-up">
          <a href="/retail/food"><button class="btn btn-secondary mg-r-10">Food <i class="fa fa-level-up"></i></button></a>
          </div>
          <a href="/retail/food/countryfarms"><button class="btn btn-primary mg-r-10">Country Farms</button></a>
            <a href="/retail/food/jollibean"><button class="btn btn-primary mg-r-10">Jollibean</button></a>
            <a href="/retail/food/krispykreme"><button class="btn btn-primary mg-r-10">Krispy Kreme</button></a>
            <a href="/retail/food/roasters"><button class="btn btn-success mg-r-10">Roasters</button></a>
            <a href="/retail/food/servergano"><button class="btn btn-primary mg-r-10">Ser Vergano</button></a>
            <a href="/retail/food/starbucks"><button class="btn btn-primary mg-r-10">Starbucks</button></a>
        </div>
        <h6 class="slim-pagetitle">Retail - Food - Roasters</h6>
    </div>
            ...
            <div class="card card-sub-data ">
                <div class="card-body">
                    ...
                    <script>
                            ...
                            console.log('EBITDA');
                        console.log(ebitdaCurrentMonthBreakdownData);
                    </script>
                </div>
            </div>
        </div><!-- card -->
...
if(opexPercentage <= 80 || {{$opex->ytd_revenue}} == 0){
