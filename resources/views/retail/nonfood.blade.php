...
@section('title') Retail > Non-Food @endsection
...
<div class="slim-mainpanel">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/retail/non-food/cosway"><button class="btn btn-primary mg-r-10">Cosway MY</button></a>
        ...
        <h6 class="slim-pagetitle">Retail - Non-Food</h6>
    </div>
