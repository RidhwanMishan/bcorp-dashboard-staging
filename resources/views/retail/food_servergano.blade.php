...
@section('title') Retail > Food > Ser Vergano @endsection
...
<div class="container">
    <div class="slim-pageheader">
        <div>
          ...
          <a href="/retail/food/servergano"><button class="btn btn-success mg-r-10">Ser Vergano</button></a>
          <a href="/retail/food/starbucks"><button class="btn btn-primary mg-r-10">Starbucks</button></a>
        </div>
        <h6 class="slim-pagetitle">Retail - Food - Ser Vergano</h6>
    </div>
