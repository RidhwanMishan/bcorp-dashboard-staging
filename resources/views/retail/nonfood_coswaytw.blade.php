...
@section('title') Retail > Non-Food > Cosway TW Branch @endsection
    ...
    <div class="slim-pageheader">
        ...
        @if($userID == 1)
          <div class="level-up">
            ...
            <a href="/retail/non-food/coswaytw"><button class="btn btn-success mg-r-10">Cosway TW</button></a>
        ...
        <h6 class="slim-pagetitle">Retail - Non-Food - Cosway TW Branch</h6>
    </div>
