...
@section('title') Retail > Non-Food > Cosway HK Limited @endsection
    ...
    <div class="slim-pageheader">
        ...
        @if($userID == 1)
          <div class="level-up">
            ...
            <a href="/retail/non-food/coswayhk"><button class="btn btn-success mg-r-10">Cosway HK</button></a>
        ...
        <h6 class="slim-pagetitle">Retail - Non-Food - Cosway HK Limited</h6>
    </div>
