...
@section('title') Retail > Food > Country Farms Sdn Bhd @endsection
    ...
    <div class="slim-pageheader">
        ...
        @if($userID == 1)
          <div class="level-up">
            ...
            <a href="/retail/food/countryfarms"><button class="btn btn-success mg-r-10">Country Farms</button></a>
        ...
        <h6 class="slim-pagetitle">Retail - Food - Country Farms Sdn Bhd</h6>
    </div>
