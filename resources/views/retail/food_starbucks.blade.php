...
@section('title') Retail > Food > Starbucks @endsection
    ...
    <div class="slim-pageheader">
        ...
        <div class="level-up">
          ...
          <a href="/retail/food/countryfarms"><button class="btn btn-primary mg-r-10">Country Farms</button></a>
            ...
            <a href="/retail/food/starbucks"><button class="btn btn-success mg-r-10">Starbucks</button></a>
        </div>
        <h6 class="slim-pagetitle">Retail - Food - Starbucks</h6>
    </div>
