...
@section('title') Retail > Food @endsection
...
<div class="slim-mainpanel">
    ...
    <div class="slim-pageheader">
        <div>
        <div class="level-up">
        <a href="/retail"><button class="btn btn-secondary mg-r-10">Retail <i class="fa fa-level-up"></i></button></a>
        </div>
        <a href="/retail/food/countryfarms"><button class="btn btn-primary mg-r-10">Country Farms</button></a>
            ...
            <a href="/retail/food/roasters"><button class="btn btn-primary mg-r-10">Roasters</button></a>
      ...
      <h6 class="slim-pagetitle">Retail - Food</h6>
    </div>
