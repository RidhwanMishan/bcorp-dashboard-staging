...
@section('title') Retail @endsection
...
<div class="slim-mainpanel">
    ...
    <div class="slim-pageheader">
        <div>
        <a href="retail/food"><button class="btn btn-primary mg-r-10">Food</button></a>
        <a href="retail/non-food"><button class="btn btn-primary mg-r-10">Non-Food</button></a>
        <a href="/berjaya"><button class="btn btn-secondary mg-r-10">Berjaya Group <i class="fa fa-level-up"></i></button></a>  
      </div>
        <h6 class="slim-pagetitle">Retail</h6>
    </div>
