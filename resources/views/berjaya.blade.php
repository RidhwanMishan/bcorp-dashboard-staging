...
@section('title') Berjaya Group @endsection
...
<div class="slim-mainpanel">
    ...
    <div class="slim-pageheader">
        ...
        <h6 class="slim-pagetitle">Berjaya Group</h6>
    </div>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body pd-b-0">
                ...
                <script>
                      var ctx = document.getElementById('MonthlyActualTargetChart').getContext('2d');
                      var revenueMonthlyActualTargetChart = new Chart(ctx, {
                            type: 'line',
                            data:{
                                  labels:  <?php echo json_encode ($revenue_detailed_monthly_labels); ?>,
                                  datasets: [{
                                  label:actualTextLabel,
                                  data: <?php echo json_encode($revenue_detailed_monthly_data_actual); ?>,
                               ...
                               },
                                {
                                    ...
                                    data: <?php echo json_encode($revenue_detailed_monthly_data_target); ?>,
...
<?php
if($revenue->ytd_target == null){
    $revenue->ytd_target = 0;
}
?>
