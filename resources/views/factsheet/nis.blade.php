...
@php
$name = 'Natural Intelligence Solutions Pte Ltd';
@endphp
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-8 mb-4">
            ...
            <div class="row row-xs mt-2">
                    ...
                    <table class="table table-striped mg-b-0">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="75%">{!! $keyfact_fact_value[$index] !!}</td>
                        </tr>
                        @endforeach
                      </tbody>
                    </table>
                ...
                <div class="col-md-6">
                    <table class="table mg-b-0" style="background-color: #f8f9fa;">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="60%">{{ $management_fact_value[$index] }}</td>
                        </tr>
                        @endforeach
                      </tbody>
                    </table>
                    ...
                    <table class="table table-striped mg-b-0">
                      <tbody class="text-center">
                        ...
                        <tr>
                          ...
                          <td>
                            <strong>{{ $sound_fact_value[$index] }}</strong>
