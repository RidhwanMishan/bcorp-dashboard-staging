...
@section('title') Hospitality > Hotels & Resorts > BHR (Cayman) Limited @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <div class="level-up">
          ...
          <a href="/hospitality/hotels/bhrcayman"><button class="btn btn-success mg-r-10">BHR (Cayman)</button></a>
        ...
        <h6 class="slim-pagetitle">Hospitality - Hotels & Resorts - BHR (Cayman) Limited</h6>
    </div>
