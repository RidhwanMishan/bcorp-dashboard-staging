...
@section('title') Hospitality > Recreation Clubs > KDE Recreation @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/hospitality/clubs/kde"><button class="btn btn-success mg-r-10">KDE</button></a>
        <a href="/hospitality/clubs/staffield"><button class="btn btn-primary mg-r-10">Staffield</button></a>
        </div>
        <h6 class="slim-pagetitle">Hospitality - Recreation Clubs - KDE Recreation</h6>
    </div>
