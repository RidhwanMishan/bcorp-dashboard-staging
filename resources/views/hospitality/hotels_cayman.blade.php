...
@section('title') Hospitality > Hotels & Resorts > Berjaya Vacation Club (Cayman) @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <div class="level-up">
          ...
          <a href="/hospitality/hotels/cayman"><button class="btn btn-success mg-r-10">Cayman</button></a>
        ...
        <h6 class="slim-pagetitle">Hospitality - Hotels & Resorts - Berjaya Vacation Club (Cayman)</h6>
    </div>
