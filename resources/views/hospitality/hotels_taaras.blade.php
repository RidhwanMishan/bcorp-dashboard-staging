...
@section('title') Hospitality > Hotels & Resorts > Taaras Beach & Spa Resort (Redang) @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <div class="level-up">
          ...
          <a href="/hospitality/hotels/taaras"><button class="btn btn-success mg-r-10">Taaras</button></a>
        ...
        <h6 class="slim-pagetitle">Hospitality - Hotels & Resorts - Taaras Beach & Spa Resort (Redang)</h6>
    </div>
