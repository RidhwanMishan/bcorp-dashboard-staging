...
@section('title') Hospitality > Recreation Clubs > Staffield Country Resort @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        <div>
        <div class="level-up">
          <a href="/hospitality/clubs"><button class="btn btn-secondary mg-r-10">Recreation Clubs <i class="fa fa-level-up"></i></button></a>
        </div>
        ...
        <a href="/hospitality/clubs/staffield"><button class="btn btn-success mg-r-10">Staffield</button></a>
        </div>
        <h6 class="slim-pagetitle">Hospitality - Recreation Clubs - Staffield Country Resort</h6>
    </div>
