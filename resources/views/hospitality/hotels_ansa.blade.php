...
@section('title') Hospitality > Hotels & Resorts > ANSA Hotel KL @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        <div>
          ...
          <a href="/hospitality/hotels/ansa"><button class="btn btn-success mg-r-10">ANSA</button></a>
        ...
        <h6 class="slim-pagetitle">Hospitality - Hotels & Resorts - ANSA Hotel KL</h6>
    </div>
