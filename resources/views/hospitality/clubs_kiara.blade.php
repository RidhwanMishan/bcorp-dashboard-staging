...
@section('title') Hospitality > Recreation Clubs > Bukit Kiara @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/hospitality/clubs/kiara"><button class="btn btn-success mg-r-10">Bukit Kiara</button></a>
        ...
        <h6 class="slim-pagetitle">Hospitality - Recreation Clubs - Bukit Kiara Resort</h6>
    </div>
