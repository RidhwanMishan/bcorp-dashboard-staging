@extends('hospitality.index')

@section('title') Hospitality > Hotels & Resorts @endsection

@section('content')
<script>
var companyPage = false;
...
<div class="slim-mainpanel">
    ...
    <div class="slim-pageheader">
        <div>
        <div class="level-up">
        <a href="/hospitality"><button class="btn btn-secondary mg-r-10">Hospitality <i class="fa fa-level-up"></i></button></a>
        </div>
        <a href="/hospitality/hotels/ansa"><button class="btn btn-primary mg-r-10">ANSA</button></a>
          <a href="/hospitality/hotels/beau"><button class="btn btn-primary mg-r-10">Beau Vallon</button></a>
          <a href="/hospitality/hotels/hills"><button class="btn btn-primary mg-r-10">B. Hills</button></a>
          <a href="/hospitality/hotels/bhrcayman"><button class="btn btn-primary mg-r-10">BHR (Cayman)</button></a>
          <a href="/hospitality/hotels/bts"><button class="btn btn-primary mg-r-10">BTS</button></a>
          <a href="/hospitality/hotels/cayman"><button class="btn btn-primary mg-r-10">Cayman</button></a>
          <a href="/hospitality/hotels/hotay"><button class="btn btn-primary mg-r-10">Hotay</button></a>
          <a href="/hospitality/hotels/ireland"><button class="btn btn-primary mg-r-10">Ireland</button></a>
          <a href="/hospitality/hotels/kyoto"><button class="btn btn-primary mg-r-10">Kyoto</button></a>
          <a href="/hospitality/hotels/langkawi"><button class="btn btn-primary mg-r-10">Langkawi</button></a>
          <a href="/hospitality/hotels/mount"><button class="btn btn-primary mg-r-10">Mount Royal</button></a>
          <a href="/hospitality/hotels/okinawa"><button class="btn btn-primary mg-r-10">Okinawa</button></a>
          <a href="/hospitality/hotels/perdana"><button class="btn btn-primary mg-r-10">Perdana</button></a>
          <a href="/hospitality/hotels/praslin"><button class="btn btn-primary mg-r-10">Praslin</button></a>
          <a href="/hospitality/hotels/taaras"><button class="btn btn-primary mg-r-10">Taaras</button></a>
          <a href="/hospitality/hotels/tioman"><button class="btn btn-primary mg-r-10">Tioman</button></a>
          <a href="/hospitality/hotels/vacation"><button class="btn btn-primary mg-r-10">Vacation</button></a>
        </div>
        <h6 class="slim-pagetitle">Hospitality - Hotels & Resorts</h6>
    </div>
            ...
            <div class="card-body">
                    ...
                    <script>
                        var ebitdaCurrentMonthBreakdownData = {
                                datasets: [{
                                data: <?php echo json_encode($ebitda_breakdown_data); ?>,
                                backgroundColor: preChosenBackgroundColors
                                }],
                                labels: <?php echo json_encode($ebitda_breakdown_labels); ?>,
