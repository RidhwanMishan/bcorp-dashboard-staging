...
@section('title') Hospitality > Recreation Clubs > Indah Corp @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/hospitality/clubs/indah"><button class="btn btn-success mg-r-10">Indah Corp</button></a>
        ...
        <h6 class="slim-pagetitle">Hospitality - Recreation Clubs - Indah Corp Berhad</h6>
    </div>
