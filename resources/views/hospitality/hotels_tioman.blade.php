...
@section('title') Hospitality > Hotels & Resorts > Tioman Island Resort @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <div class="level-up">
          ...
          <a href="/hospitality/hotels/tioman"><button class="btn btn-success mg-r-10">Tioman</button></a>
          <a href="/hospitality/hotels/vacation"><button class="btn btn-primary mg-r-10">Vacation</button></a>
        </div>
        <h6 class="slim-pagetitle">Hospitality - Hotels & Resorts - Tioman Island Resort</h6>
    </div>
