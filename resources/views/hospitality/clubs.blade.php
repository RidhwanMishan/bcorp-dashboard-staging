...
@section('title') Hospitality > Recreation Clubs @endsection
...
<div class="slim-mainpanel">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/hospitality/clubs/kiara"><button class="btn btn-primary mg-r-10">Bukit Kiara</button></a>
        <a href="/hospitality/clubs/golf"><button class="btn btn-primary mg-r-10">Golf Resort</button></a>
        <a href="/hospitality/clubs/hills"><button class="btn btn-primary mg-r-10">Hills Resort</button></a>
        <a href="/hospitality/clubs/indah"><button class="btn btn-primary mg-r-10">Indah Corp</button></a>
        <a href="/hospitality/clubs/kde"><button class="btn btn-primary mg-r-10">KDE</button></a>
        <a href="/hospitality/clubs/staffield"><button class="btn btn-primary mg-r-10">Staffield</button></a>
        </div>
        <h6 class="slim-pagetitle">Hospitality - Recreation Clubs</h6>
    </div>
