...
@section('title') Hospitality > Recreation Clubs > Berjaya Hills @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/hospitality/clubs/hills"><button class="btn btn-success mg-r-10">Hills Resort</button></a>
        ...
        <h6 class="slim-pagetitle">Hospitality - Recreation Clubs - Berjaya Hills</h6>
    </div>
