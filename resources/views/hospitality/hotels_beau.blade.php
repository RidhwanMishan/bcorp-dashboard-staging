...
@section('title') Hospitality > Hotels & Resorts > Berjaya Beau Vallon Bay Resort @endsection
...
<div class="slim-mainpanel company bloyalty">
    <div class="container">
    <div class="slim-pageheader">
        <div>
        <div class="level-up">
          <a href="/hospitality/hotels"><button class="btn btn-secondary mg-r-10">Hotels & Resorts <i class="fa fa-level-up"></i></button></a>
          </div>
          <a href="/hospitality/hotels/ansa"><button class="btn btn-primary mg-r-10">ANSA</button></a>
          <a href="/hospitality/hotels/beau"><button class="btn btn-success mg-r-10">Beau Vallon</button></a>
        ...
        <h6 class="slim-pagetitle">Hospitality - Hotels & Resorts - Berjaya Beau Vallon Bay Resort</h6>
    </div>
