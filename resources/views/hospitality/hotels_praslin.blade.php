...
@section('title') Hospitality > Hotels & Resorts > Berjaya Praslin Limited @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <div class="level-up">
          ...
          <a href="/hospitality/hotels/praslin"><button class="btn btn-success mg-r-10">Praslin</button></a>
        ...
        <h6 class="slim-pagetitle">Hospitality - Hotels & Resorts - Berjaya Praslin Limited</h6>
    </div>
