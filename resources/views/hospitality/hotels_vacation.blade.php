...
@section('title') Hospitality > Hotels & Resorts > Berjaya Vacation Club @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <div class="level-up">
          ...
          <a href="/hospitality/hotels/vacation"><button class="btn btn-success mg-r-10">Vacation</button></a>
        </div>
        <h6 class="slim-pagetitle">Hospitality - Hotels & Resorts - Berjaya Vacation Club</h6>
    </div>
