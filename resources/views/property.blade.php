...
@section('title') Property @endsection
...
<div class="slim-mainpanel">
    ...
    <div class="slim-pageheader">
        <div>
        <a href="property/development"><button class="btn btn-primary mg-r-10">Development</button></a>
        <a href="property/investment"><button class="btn btn-primary mg-r-10">Investment</button></a>
        <!--a href="property/housing"><button class="btn btn-primary mg-r-10">Affordable Housing</button></a-->
        <a href="/berjaya"><button class="btn btn-secondary mg-r-10">Berjaya Group <i class="fa fa-level-up"></i></button></a>  
      </div>
        <h6 class="slim-pagetitle">Property</h6>
    </div>
