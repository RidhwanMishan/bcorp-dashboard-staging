...
@section('title') Hospitality @endsection
...
<div class="slim-mainpanel">
    ...
    <div class="slim-pageheader">
        <div>
        <a href="hospitality/hotels"><button class="btn btn-primary mg-r-10">Hotels & Resorts</button></a>
        <a href="hospitality/clubs"><button class="btn btn-primary mg-r-10">Recreation Clubs</button></a>
        <a href="/berjaya"><button class="btn btn-secondary mg-r-10">Berjaya Group <i class="fa fa-level-up"></i></button></a>
        </div>
        <h6 class="slim-pagetitle">Hospitality</h6>
    </div>
