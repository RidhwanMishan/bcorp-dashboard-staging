...
<div class="slim-mainpanel">
    ...
    <div class="slim-pageheader">
      <div>
        <!--a href="/services/gaming"><button class="btn btn-primary mg-r-10">Gaming</button></a-->
        <a href="/services/digital"><button class="btn btn-primary mg-r-10">Digital Services</button></a>
        <a href="/services/environment"><button class="btn btn-primary mg-r-10">Environment</button></a>
        <a href="/services/financial"><button class="btn btn-primary mg-r-10">Financial</button></a>
        <a href="/services/logistics"><button class="btn btn-primary mg-r-10">Logistics</button></a>
        <a href="/berjaya"><button class="btn btn-secondary mg-r-10">Berjaya Group <i class="fa fa-level-up"></i></button></a>
      </div>
      <h6 class="slim-pagetitle">Services</h6>
    </div>
