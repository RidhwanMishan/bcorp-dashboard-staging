...
@section('title') Property > Investment > Stephens Properties @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        <div>
        <div class="level-up">
          <a href="/property/investment"><button class="btn btn-secondary mg-r-10">Investment <i class="fa fa-level-up"></i></button></a>
          </div>
        ...
        <a href="/property/investment/stephens"><button class="btn btn-success mg-r-10">Stephens</button></a>
        </div>
        <h6 class="slim-pagetitle">Property - Investment - Stephens Properties</h6>
    </div>
