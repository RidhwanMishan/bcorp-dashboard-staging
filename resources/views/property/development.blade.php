...
@section('title') Property > Property Development @endsection
...
<div class="slim-mainpanel">
    ...
    <div class="slim-pageheader">
        <div>
        <div class="level-up">
        <a href="/property"><button class="btn btn-secondary mg-r-10">Property <i class="fa fa-level-up"></i></button></a>
        </div>
        <a href="/property/development/angsana"><button class="btn btn-primary mg-r-10">Angsana</button></a>
          <a href="/property/development/bland"><button class="btn btn-primary mg-r-10">Berjaya Land</button></a>
          <a href="/property/development/golf"><button class="btn btn-primary mg-r-10">Golf Resort</button></a>
          <a href="/property/development/handico12"><button class="btn btn-primary mg-r-10">Handico12</button></a>
          <a href="/property/development/okinawa"><button class="btn btn-primary mg-r-10">Okinawa</button></a>
          <a href="/property/development/tagar"><button class="btn btn-primary mg-r-10">Tagar</button></a>
          <a href="/property/development/tar"><button class="btn btn-primary mg-r-10">Taman TAR</button></a>
          <a href="/property/development/wangsategap"><button class="btn btn-primary mg-r-10">Wangsa Tegap</button></a>
        </div>
        <h6 class="slim-pagetitle">Property - Property Development</h6>
    </div>
