...
@section('title') Property > Development > Taman TAR Development @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <div class="level-up">
          ...
          <a href="/property/development/tar"><button class="btn btn-success mg-r-10">Taman TAR</button></a>
          <a href="/property/development/wangsategap"><button class="btn btn-primary mg-r-10">Wangsa Tegap</button></a>
        </div>
        <h6 class="slim-pagetitle">Property - Development - Taman TAR Development</h6>
    </div>
