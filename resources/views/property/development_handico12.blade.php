...
@section('title') Property > Development > Berjaya Handico12 Co Ltd @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        <div>
        <div class="level-up">
          <a href="/property/development"><button class="btn btn-secondary mg-r-10">Development <i class="fa fa-level-up"></i></button></a>
          </div>
          ...
          <a href="/property/development/handico12"><button class="btn btn-success mg-r-10">Handico12</button></a>
        ...
        <h6 class="slim-pagetitle">Property - Development - Berjaya Handico12 Co Ltd</h6>
    </div>
