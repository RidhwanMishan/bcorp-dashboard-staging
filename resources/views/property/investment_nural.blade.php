...
@section('title') Property > Investment > Nural Enterprise @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/property/investment/nural"><button class="btn btn-success mg-r-10">Nural</button></a>
        <a href="/property/investment/stephens"><button class="btn btn-primary mg-r-10">Stephens</button></a>
        </div>
        <h6 class="slim-pagetitle">Property - Investment - Nural Enterprise</h6>
    </div>
