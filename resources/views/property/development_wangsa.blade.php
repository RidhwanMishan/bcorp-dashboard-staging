...
@section('title') Property > Development > Wangsa Tegap @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <div class="level-up">
          ...
          <a href="/property/development/wangsategap"><button class="btn btn-success mg-r-10">Wangsa Tegap</button></a>
        </div>
        <h6 class="slim-pagetitle">Property - Development - Wangsa Tegap</h6>
    </div>
