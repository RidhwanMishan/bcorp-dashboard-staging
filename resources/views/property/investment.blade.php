...
@section('title') Property > Property Investment @endsection
...
<div class="slim-mainpanel">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/property/investment/cempaka"><button class="btn btn-primary mg-r-10">Cempaka</button></a>
        <a href="/property/investment/kotaraya"><button class="btn btn-primary mg-r-10">Kota Raya</button></a>
        <a href="/property/investment/nural"><button class="btn btn-primary mg-r-10">Nural</button></a>
        <a href="/property/investment/stephens"><button class="btn btn-primary mg-r-10">Stephens</button></a>
        </div>
        <h6 class="slim-pagetitle">Property - Property Investment</h6>
    </div>
