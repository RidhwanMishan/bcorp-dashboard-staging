...
@section('title') Services > Digital Services > BLoyalty @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/services/digital/bloyalty"><button class="btn btn-success mg-r-10">BLoyalty</button></a>
        ...
        <h6 class="slim-pagetitle">Services - Digital Services - BLoyalty</h6>
    </div>
