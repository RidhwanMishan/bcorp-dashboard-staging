...
@section('title') Services > Environment > Berjaya EnviroParks Sdn Bhd @endsection
...
<div class="slim-mainpanel company">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/services/environment/enviroparks"><button class="btn btn-success mg-r-10">EnviroParks</button></a>
        @else
          @if($enviro_holdings)
          <a href="/services/environment/enviroholdings"><button class="btn btn-primary mg-r-10">Enviro Holdings</button></a>
          @endif
        ...
        <h6 class="slim-pagetitle">Services - Environment - Berjaya EnviroParks Sdn Bhd</h6>
    </div>
