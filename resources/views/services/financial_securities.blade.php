...
@section('title') Services > Financial Technology > Inter-Pacific Securities @endsection
...
<div class="slim-mainpanel company">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/services/financial/interpac-securities"><button class="btn btn-success mg-r-10">Inter-Pac Securities</button></a>
        <a href="/services/financial/interpac-trading"><button class="btn btn-primary mg-r-10">Inter-Pac Trading</button></a>
        </div>
        <h6 class="slim-pagetitle">Services - Financial - Inter-Pac Securities</h6>
    </div>
