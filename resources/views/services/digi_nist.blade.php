...
@section('title') Services > Digital Services > Natural Intelligence Solutions Technology @endsection
...
<div class="slim-mainpanel company">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/services/digital/nist"><button class="btn btn-success mg-r-10">NIST</button></a>
        ...
        <h6 class="slim-pagetitle">Services - Digital Services - NIST Sdn Bhd</h6>
    </div>
