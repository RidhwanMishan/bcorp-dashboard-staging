...
@section('title') Services > Financial Technology @endsection
...
<div class="slim-mainpanel">
    ...
    <div class="slim-pageheader">
        <div>
        <div class="level-up"><a href="/services"><button class="btn btn-secondary mg-r-10">Services <i class="fa fa-level-up"></i></button></a>
        </div>
        <a href="/services/financial/interpac-asset"><button class="btn btn-primary mg-r-10">Inter-Pac Asset</button></a>
        <a href="/services/financial/interpac-research"><button class="btn btn-primary mg-r-10">Inter-Pac Research</button></a>
        <a href="/services/financial/interpac-securities"><button class="btn btn-primary mg-r-10">Inter-Pac Securities</button></a>
        <a href="/services/financial/interpac-asset"><button class="btn btn-primary mg-r-10">Inter-Pac Trading</button></a>
        </div>
        <h6 class="slim-pagetitle">Services - Financial</h6>
    </div>
