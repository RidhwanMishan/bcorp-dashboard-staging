...
@section('title') Services > Financial Technology > Inter-Pacific Research @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/services/financial/interpac-research"><button class="btn btn-success mg-r-10">Inter-Pac Research</button></a>
        ...
        <h6 class="slim-pagetitle">Services - Financial - Inter-Pac Research</h6>
    </div>
