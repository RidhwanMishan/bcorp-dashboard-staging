...
@section('title') Services > Logistics @endsection
...
<div class="slim-mainpanel">
    ...
    <div class="slim-pageheader">
        <div>
        <a href="/services/logistics/secure"><button class="btn btn-primary mg-r-10">Secure Express</button></a>
        <a href="/services"><button class="btn btn-secondary mg-r-10">Services <i class="fa fa-level-up"></i></button></a>
        </div>
        <h6 class="slim-pagetitle">Services - Logistics</h6>
    </div>
...
<div class="row row-xs">
    ...
    <div id="PrimaryCOSCard" class="card">
        ...
        <h6 class="slim-card-title">Cost of Sale</h6>
    ...
    <div id="PrimaryEBITDACard" class="card">
        ...
        <div class="card-body">
                ...
                <script>
                    var data = <?php echo json_encode($ebitda_breakdown_data); ?>;
                    if (data.length == 0) {
                      data = [100];
                    }
                    var label = <?php echo json_encode($ebitda_breakdown_labels); ?>;
                    if (label.length == 0) {
                      label = ['EBITDA no data'];
                    }
