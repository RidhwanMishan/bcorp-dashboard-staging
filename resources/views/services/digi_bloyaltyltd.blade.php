...
@section('title') Services > Digital Services > BLoyalty Ltd @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/services/digital/bloyaltyltd"><button class="btn btn-success mg-r-10">BLoyalty Ltd</button></a>
        <a href="/services/digital/nis"><button class="btn btn-primary mg-r-10">NIS</button></a>
        ...
        @else
          ...
          @endif
          @if($bloyaltyltd)
          <a href="/services/digital/bloyaltylte"><button class="btn btn-success mg-r-10">BLoyalty Ltd</button></a>
          @endif
        @endif
        </div>
        <h6 class="slim-pagetitle">Services - Digital Services - BLoyalty Ltd</h6>
    </div>
