...
@section('title') Services > Financial Technology > Inter-Pacific Trading @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/services/financial/interpac-trading"><button class="btn btn-success mg-r-10">Inter-Pac Trading</button></a>
        </div>
        <h6 class="slim-pagetitle">Services - Financial - Inter-Pac Trading</h6>
    </div>
