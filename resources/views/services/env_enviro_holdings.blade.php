...
@section('title') Services > Environment > Berjaya Enviro Holdings Sdn Bhd @endsection
...
<div class="slim-mainpanel company">
    ...
    <div class="slim-pageheader">
        ...
        @if($userID == 1)
        <div class="level-up">
          <a href="/services/environment"><button class="btn btn-secondary mg-r-10">Environment <i class="fa fa-level-up"></i></button></a>
          </div>
        <a href="/services/environment/enviroholdings"><button class="btn btn-success mg-r-10">Enviro Holdings</button></a>
        <a href="/services/environment/enviroparks"><button class="btn btn-primary mg-r-10">EnviroParks</button></a>
        @else
          @if($enviro_holdings)
          <a href="/services/environment/enviroholdings"><button class="btn btn-success mg-r-10">Enviro Holdings</button></a>
          @endif
        ...
        <h6 class="slim-pagetitle">Services - Environment - Berjaya Enviro Holdings Sdn Bhd</h6>
    </div>
