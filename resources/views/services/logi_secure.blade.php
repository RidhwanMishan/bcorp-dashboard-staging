...
@section('title') Services > Logistics > Secure Express Services @endsection
...
<div class="slim-mainpanel company">
    ...
    <div class="slim-pageheader">
        <div>
        @if($userID == 1)
        <a href="/services/digital/nis"><button class="btn btn-success mg-r-10">Secure Express</button></a>
        <a href="/services/logistics"><button class="btn btn-secondary mg-r-10">Logistics <i class="fa fa-level-up"></i></button></a>
        @else
          @if($logi_secure)
          <a href="/services/digital/nis"><button class="btn btn-success mg-r-10">Secure Express</button></a>
          @endif
        ...
        <h6 class="slim-pagetitle">Services - Logistics - Secure Express Services Sdn Bhd</h6>
    </div>
    ...
    <div class="row row-xs">
        ...
        <div id="PrimaryGPLCard" class="card">
            ...
            <h6 class="slim-card-title">Gross Profit / Loss</h6>
