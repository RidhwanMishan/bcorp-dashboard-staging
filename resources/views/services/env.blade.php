...
@section('title') Services > Environment @endsection
...
<div class="slim-mainpanel">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/services/environment/enviroholdings"><button class="btn btn-primary mg-r-10">Enviro Holdings</button></a>
        <a href="/services/environment/enviroparks"><button class="btn btn-primary mg-r-10">EnviroParks</button></a>
        </div>
        <h6 class="slim-pagetitle">Services - Environment</h6>
    </div>
