...
@section('title') Services > Digital Services > REDtone International Berhad @endsection
...
<div class="slim-mainpanel company">
    ...
    <div class="slim-pageheader">
        ...
        <a href="/services/digital/redtone"><button class="btn btn-success mg-r-10">REDtone</button></a>
        @else
          @if($redtone)
          <a href="/services/digital/redtone"><button class="btn btn-success mg-r-10">REDtone</button></a>
          @endif
        ...
        <h6 class="slim-pagetitle">Services - Digital Services - REDtone International Berhad</h6>
    </div>
