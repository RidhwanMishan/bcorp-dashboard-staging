...
@section('title') Services > Financial Technology > Inter-Pacific Asset Management @endsection
...
<div class="slim-mainpanel company bloyalty">
    ...
    <div class="slim-pageheader">
        <div>
          <div class="level-up"><a href="/services/financial"><button class="btn btn-secondary mg-r-10">Financial<i class="fa fa-level-up"></i></button></a>
          </div>
        <a href="/services/financial/interpac-asset"><button class="btn btn-success mg-r-10">Inter-Pac Asset</button></a>
        ...
        <a href="/services/financial/interpac-trading"><button class="btn btn-primary mg-r-10">Inter-Pac Trading</button></a>
        </div>
        <h6 class="slim-pagetitle">Services - Financial - Inter-Pac Asset Mgmt</h6>
    </div>
